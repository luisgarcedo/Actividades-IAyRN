...
# Extrae automáticamente las etiquetas detectadas basándose en los nombres de las carpetas físicas.
clases = list(train_generator.class_indices.keys())
num_clases = len(clases)
print(f"Fotos detectadas en carpetas: {clases}")
...
while True:
    ...
    if probabilidad > 0.92:
        # Si supera el 92%, recuperamos el nombre real de la letra
